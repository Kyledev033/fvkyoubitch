...
module.exports = {
    config: {
        name: "help",
        version: "1.18",
        author: "NTKhang x Symer(MRKIMSTER)",
        countDown: 5,
        role: 0,
        shortDescription: {
    ...
    langs: {
        en: {
            help: "╭━━━━━━━━━━━━━━━━╮\n〡𓃵𝗭𝗲𝗽𝗵𝘆𝗿𝘂𝘀 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀𝗟𝗶𝘀𝘁〡\n╰━━━━━━━━━━━━━━━━╯\n╭──────┉┉┉────❃\n╠%1\n╰─────┉┉┉──────𖤓\n⧽⧽ 𝗣𝗮𝗴𝗲: %2/%3\n╰╾⪼ ℹ️Use .𝗵𝗲𝗹𝗽 [page number] to display the information on the additional pages.\n╭──────┉┉┉────❖\n╠──────┉┉┉────✧\n〡The company itself is a very successful company.\n〡Therefore, if we can be freed from the smallest things,\n〡 it will follow that they are chosen in \n〡true pains and pleasures!\n╠◈➤『𝗞𝘆𝗹𝗲𝗽𝗼𝗴𝗶』\n╰───────────❃",
