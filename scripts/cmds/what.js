...
const API_KEY = "AIzaSyDJDvY9LG-DSHRnbisNpINbf4nPYxndZuE"; //put key here
...
module.exports = {
    config: {
        ...
        role: 0,
        description: {
            en: "Fast input text and images with Ai.Gemini 1.5 flash. Upto 1M context window."
        },
        guide: { en: "{pn} <query>" },
        category: "ai",
    },
    onStart: async function ({ api, message, event, args, commandName }) {
        ...
        if (event.type == "message_reply" && contentTextOnly) {
            ...
            try {
                ...
                api.sendMessage(`𓃵 𝗭𝗘𝗣𝗛 [𝗔𝗜.𝗚]:\n▬▬▬▬▬▬▬▬▬▬▬▬\n${text}\n▬▬▬▬▬▬▬▬▬▬▬▬\n𝗧𝗼𝘁𝗮𝗹 𝗪𝗼𝗿𝗱𝘀: ${wordCount}\n𝗣𝗿𝗼𝗰𝗲𝘀𝘀 𝗧𝗶𝗺𝗲: ${totalTimeInSeconds.toFixed(2)} 𝘀𝗲𝗰𝗼𝗻𝗱𝘀`, event.threadID, (err, info) => {
                    if (!err) {
            ...
            try {
                ...
                message.reply(`𓃵 𝗭𝗘𝗣𝗛 [𝗔𝗜.𝗚]:\n▬▬▬▬▬▬▬▬▬▬▬▬\n${text}\n▬▬▬▬▬▬▬▬▬▬▬▬\n𝗧𝗼𝘁𝗮𝗹 𝗪𝗼𝗿𝗱𝘀: ${wordCount}\n𝗣𝗿𝗼𝗰𝗲𝘀𝘀 𝗧𝗶𝗺𝗲: ${totalTimeInSeconds.toFixed(2)} 𝘀𝗲𝗰𝗼𝗻𝗱𝘀`, (err, info) => {
                    if (!err) {
                        global.GoatBot.onReply.set(info.messageID, {
                            commandName,
                            messageID: info.messageID,
